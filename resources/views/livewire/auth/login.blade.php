                ...
                <div class="login-actions">
                    ...
                    <a href="{{ route('google.login') }}" class="google-login">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path d="M21.35 11.1h-9.18v2.9h5.28c-.23 1.4-1.8 4.1-5.28 4.1-3.18 0-5.8-2.64-5.8-5.9s2.62-5.9 5.8-5.9c1.82 0 3.04.78 3.74 1.45l2.56-2.48C16.96 3.88 14.84 3 12.17 3 6.92 3 2.7 7.2 2.7 12.35S6.92 21.7 12.17 21.7c5.36 0 9.13-3.75 9.13-9.02 0-.6-.07-1.1-.15-1.58z" />
                        </svg>
                        Login dengan Google
                    </a>
                </div>
