    ...
    <div class="register-card">
        ...
        <div class="register-left">
            ...
            <p class="register-copy">
                Daftar dan nikmati kemudahan pengelolaan surat masuk, surat keluar secara digital di Universitas
                Langlangbuana.
            </p>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" wire:model="email" placeholder="email@unla.ac.id"
                        class="w-full px-4 py-3 rounded-2xl border border-gray-200 bg-gray-50 text-sm
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="{{ $showPassword ? 'text' : 'password' }}" wire:model="password"
                            ...
                            class="w-full px-4 py-3 pr-12 rounded-2xl border border-gray-200 bg-gray-50 text-sm
            focus:border-blue-400 focus:ring-4 focus:ring-blue-100 focus:outline-none transition">
                            ...
                            @if ($showPassword)
                                ...
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9.27-3.11-11-7 1.02-2.32 2.85-4.23 5.125-5.475M9.88 9.88A3 3 0 0014.12 14.12M3 3l18 18" />
                                </svg>
                            @else
                                {{-- eye --}}
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   ...
                   focus:border-blue-400 focus:ring-4 focus:ring-blue-100 focus:outline-none transition">
                        ...
                        <button type="button" wire:click="toggleConfirmPassword"
                            ...
                            @if ($showConfirmPassword)
                                {{-- eye-off --}}
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9.27-3.11-11-7
                        1.02-2.32 2.85-4.23 5.125-5.475M9.88 9.88A3 3 0 0014.12 14.12M3 3l18 18" />
                                </svg>
                            @else
                                {{-- eye --}}
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button wire:click="registerManual"
                    style="background:#173e65; box-shadow: 0 10px 18px rgba(23,62,101,.18);"
                    class="w-full mt-4 rounded-2xl px-5 py-3 text-sm font-semibold text-white transition hover:brightness-110">
